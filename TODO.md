...
- [x] Data center project research (research/01)
- [x] Hauling regulations & startup research (research/02)
- [x] Hauling economics & pricing research (research/03)
- [x] Truck & trailer specifications research (research/04)
- [x] Office space & yard research (research/05)
- [x] Site-specific hauling plans — all 5 projects (projects/)
- [x] Financial model — 5-year P&L (tools/financial-model.csv)
- [x] Contact tracker (tools/contact-tracker.md)
