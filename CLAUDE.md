...
- `research/` — Numbered deep-dive research files (01 through 05), each covering a specific topic (projects, regulations, economics, trucks, office space)
...
- `tools/` — Operational reference documents: financial model (CSV), contact tracker, truck comparison, launch checklist, office space research
...
- Financial figures should stay internally consistent across BUSINESS-PLAN.md, README.md, and tools/financial-model.csv
...
- New research topics should follow the existing numbering scheme in `research/` (next would be `06-`)
